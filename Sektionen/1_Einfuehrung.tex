...
Der in dieser Arbeit betrachtete Anwendungsfall basiert auf realen Daten eines großen deutschen Versicherungsunternehmens. Dies bringt spezifische Herausforderungen mit sich, insbesondere unvollständige Daten, fehlende Labels und einen Selection Bias, da das Modell auf Entscheidungen trainiert wird, die auf menschlicher Erfahrung und unvollständigen Prüfprozessen beruhen. Diese datenbezogenen Verzerrungen sind Grundprobleme des primären Datensatzes, werden hier aber nicht untersucht. Ziel der Arbeit ist ein robustes Modell, das die Priorisierung von zu prüfenden Fällen unterstützt und so zur Wirtschaftlichkeit der Schadenbearbeitung beiträgt.
...
\begin{enumerate}
    \item Welche Unterschiede in der Vorhersagequalität zeigen sich zwischen Cross-Attention-Modellen und einfachen Baselines wie einfacher Konkatenation oder Addition bei der Fusion von Text- und Tabellendaten?
...
Die Arbeit leistet einen Beitrag zur angewandten Forschung im Bereich multimodaler Deep-Learning-Modelle für Text- und Tabellendaten. Die wesentlichen Beiträge lassen sich wie folgt zusammenfassen:
\begin{itemize}
    \item \textbf{Entwicklung der CrossBERT-Architektur:} Konzeption und Implementierung eines Transformer-basierten Modells, das Text- und Tabellendaten mittels Cross-Attention verknüpft. Es werden mehrere Fusionsstrategien sowie ein TabularTokenizer zur Projektion von Tabellenfeatures in latente Tokens vorgestellt.
    \item \textbf{Systematische Evaluation:} Vergleich der CrossBERT-Varianten mit etablierten Baselines auf einem realen Versicherungsdatensatz und öffentlichen Benchmarks, um den Beitrag von Cross-Attention zur Fusion von Text- und Tabellendaten zu untersuchen.
    \item \textbf{Detaillierte Analyse und Ablationsstudien:} Untersuchung des Einflusses zentraler Architekturkomponenten wie der Position der Fusion, der Anzahl der Tabular Tokens und von Gating-Mechanismen. Ergänzend werden durch exemplarische Explainability-Analysen Einblicke in das Modellverhalten gewonnen.
\end{itemize}

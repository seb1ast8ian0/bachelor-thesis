...
\begin{table}[h]
    \centering
    \caption{Ergebnisse der Ablationsstudie zum Tabular Tokenizer V2}
...
\begin{table}[h]
    \centering
    \caption{Ergebnisse der Ablationsstudie zum Gating-Mechanismus}
...
\begin{table}[h]
    \centering
    \caption{Ergebnisse der Ablationsstudie zur Anzahl der Tabular Tokens ($n_{tab}$)}
    ...
    \begin{tabular}{lcc}
        ...
        CrossBERT Hybrid ($n_{tab} = 8$) & 0{,}937 & 0{,}619 \\
